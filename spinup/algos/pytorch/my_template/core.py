"""Standard template core.py for all my implementations of algorithms.

This is a standard template of the core.py file following the organization
recommended by SpinningUp and used in Spinning up implementations of algorithms.
This includes copies of helper methods for building sections of the computation graph
used across implementations and a template for the standard algorithm compatible
actor critic.
"""
